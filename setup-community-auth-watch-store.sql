...
--   https://mj-universe.net  https://mj-universe.social  https://mj-universe.media
--   https://mj-universe.watch  https://mj-universe.store  https://mjuniverse.store
--
-- Realtime: Settings -> API -> Realtime, eller:
--   alter publication supabase_realtime add table public.community_chat_messages;
-- =============================================================================

-- Staff = samme som admin-innlogging (@mj-universe.site e-post)
...
-- -----------------------------------------------------------------------------
-- Profiler (Snapchat-brukernavn ved registrering, minst 5 tegn)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Felles chat (kun innlogget; viser kun Snapchat-brukernavn fra profiles)
-- -----------------------------------------------------------------------------
...
-- Realtime: i Supabase Dashboard -> Database -> Replication, eller:
--   alter publication supabase_realtime add table public.community_chat_messages;

-- -----------------------------------------------------------------------------
-- Videoer: vlog (Media) -> spilles av pa .watch ?v=slug
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Butikk MVP (bestillinger knyttet til innlogget bruker)
-- -----------------------------------------------------------------------------
...
-- Chat-visning (RPC): staff uten profil → MJ-Universe; CREATOR for mariellogjhonatan@mj-universe.site
...
-- Oppfrisk API-schema (PostgREST) etter nye tabeller
